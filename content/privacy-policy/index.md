...
We run [Plausible](https://plausible.io/) analytics on butterops.dev. The following information is collected:

- __Page URL__. We track the page URL of each page view on this website. We use this to understand which pages have been viewed and how many times a particular page has been viewed. For example: _https://butterops.dev/_.
