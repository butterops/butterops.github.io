...
{{< alert icon="👉" text="Make sure to read the <a href=\"/communitycontribute/code-of-conduct/\">Code of Conduct</a>" >}}
...
{{< alert icon="👉" text="The documentation lives in <a href=\"https://github.com/h-enk/getdoks.org/tree/master/content/docs\">`./content/community`</a> of the <a href=\"https://github.com/h-enk/getdoks.org\">`getdoks.org` repository</a>." >}}
